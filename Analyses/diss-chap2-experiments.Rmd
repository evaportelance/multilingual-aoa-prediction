...
```{r save_data3}
saveRDS(exp2_all_cv_results, "./experiment-results/diss/exp1_all_cv_results.rds" )
saveRDS(exp2_all_cv_results_pos, "./experiment-results/diss/exp1_all_cv_results_pos.rds" )
...
saveRDS(exp3_all_lexcat_betas_resid, "./experiment-results/diss/exp2_all_lexcat_betas_resid.rds" )
saveRDS(exp3_all_word_mad_diffs_resid, "./experiment-results/diss/exp2_all_word_mad_diffs_resid.rds" )
saveRDS(exp3_all_lexcat_mad_diffs_resid, "./experiment-results/diss/exp2_all_lexcat_mad_diffs_resid.rds" )
```
