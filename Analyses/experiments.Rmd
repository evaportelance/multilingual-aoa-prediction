...
ttest_all%>% write.csv("./experiment-results/diss/exp4_ttest_results_all.csv",row.names = F, quote = T)
...
ggsave("./plots/exp4_distribution_mandarin_complete.jpeg",plot=plots_distribution_mandarin, width = 14, height =6, units="in", limitsize = FALSE)
```
...
saveRDS(exp2_all_lexcat_betas_resid_lstm, "./experiment-results/diss/exp4_all_lexcat_betas_resid_lstm_mandarin_concrete_low_1gm_high.rds" )


data <- readRDS("./experiment-results/diss/exp4_all_lexcat_betas_resid_lstm_mandarin_concrete_low_1gm_high.rds")
...
ggsave("plots_exp4_betas_resid_lstm_Sp_Mx.jpeg",plot=plots_exp2, width = 12, height = 8, units="in", limitsize = FALSE)
```
