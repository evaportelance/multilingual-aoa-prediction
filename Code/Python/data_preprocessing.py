...
def get_parameters():
    ...
    parser.add_argument("-encoding_dictionary_name", default="encoding_dictionary.pkl")
...
def main():
    ...
    utils.save_pkl(params["dataset_path"], encoding_dictionary, params["encoding_dictionary_name"])
